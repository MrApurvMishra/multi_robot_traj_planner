...
namespace SwarmPlanning {
    ...
    public:
        ...
        bool setMission_init(const ros::NodeHandle &nh);
        bool setMission_new(const ros::NodeHandle &nh, std::vector<double> curr_x, std::vector<double> curr_y);
        void applyNoise(double max_noise);
    };


    bool Mission::setMission_init(const ros::NodeHandle &nh) {
    ...
    bool Mission::setMission_new(const ros::NodeHandle &nh, std::vector<double> curr_x, std::vector<double> curr_y) {
        std::string mission_addr;
        nh.param<std::string>("mission", mission_addr, "demo");
